...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-details" class="form-control" name="row[details]" type="text" value="<?php echo htmlentities($row['details']); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="c-class" class="form-control selectpicker" name="row[class]">
                ...
                <option value="<?php echo $v['id']; ?>" <?php if(in_array(($key), explode(',',"row.class"))): ?>selected<?php endif; ?>><?php echo $v['name']; ?></option>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-goods_image" class="form-control" size="50" name="row[goods_image]" type="text" value="<?php echo htmlentities($row['goods_image']); ?>">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Browse'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-browse" class="form-control" disabled name="row[browse]" type="number" value="<?php echo htmlentities($row['browse']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Collect'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-collect" class="form-control" disabled name="row[collect]" type="number" value="<?php echo htmlentities($row['collect']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-create_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" disabled name="row[create_time]" type="text" value="<?php echo $row['create_time']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Status'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <select id="c-status" class="form-control selectpicker" disabled name="row[status]">
                <?php if(is_array($statusList) || $statusList instanceof \think\Collection || $statusList instanceof \think\Paginator): if( count($statusList)==0 ) : echo "" ;else: foreach($statusList as $key=>$v): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['status'])?$row['status']:explode(',',$row['status']))): ?>selected<?php endif; ?>><?php echo $v; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-comment" class="form-control " rows="5" name="row[comment]" cols="50"><?php echo htmlentities($row['comment']); ?></textarea>
        </div>
    </div>
